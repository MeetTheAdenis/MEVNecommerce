...
module.exports = {
	init: function (app) {
		...
		router.post("/saveConfigurations", auth, async function(request, result) {
			const admin = request.admin
			const stripePublishableKey = request.fields.stripePublishableKey
			const stripeSecretKey = request.fields.stripeSecretKey
			const paypalClientId = request.fields.paypalClientId
