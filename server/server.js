...
http.listen(port, function () {
    ...
    //
    mongoClient.connect("mongodb+srv://admin:Adonis123@ecommerce.wha8vg0.mongodb.net/?retryWrites=true&w=majority", async function (error, client) {
        if (error) {
            console.error(error)
            return
        }
        const db = client.db("ecommerce")//_free
        global.db = db
